...
void Initialize(ros::NodeHandle& n) {
...
#if 0
    // test setting 3	
    xinit = -5.0;yinit = 1.0;thetainit = 3.14 / 6.0;
    ...
    xinit = 0.0;yinit = -3.0;thetainit = 3.14;
    xr = 0.0;yr = 5.732;thetar = 0.0;
    std::vector<double> obst1 = { 0.0,0.0 };
    std::vector<std::vector<double>> neig1(N + 1, std::vector<double>{-2.0, -6.0});
    std::vector<std::vector<double>> neig2(N + 1, std::vector<double>{2.0, 6.0});
#endif 

#if 0
    // test setting for formation 2
    xinit = 0.0;yinit = -3.0;thetainit = -1.57;
    xr = 0.0;yr = 5.732;thetar = 0.0;
    std::vector<double> obst1 = { 0.0,0.0 };
    std::vector<std::vector<double>> neig1(N + 1, std::vector<double>{-4.0, -8.0});
    std::vector<std::vector<double>> neig2(N + 1, std::vector<double>{4.0, 8.0});
#endif 

#if 0
    // test setting for formation 3
    xinit = -3.0;yinit = -7.0;thetainit = -1.57;
    xr = 0.0;yr = 5.732;thetar = 0.0;
    std::vector<double> obst1 = { 0.0,0.0 };
    std::vector<std::vector<double>> neig1(N + 1, std::vector<double>{0.0, -7.0});
    std::vector<std::vector<double>> neig2(N + 1, std::vector<double>{3.0, -7.0});
#endif 

    /**xinit=-2.0;yinit=0.5;thetainit=1.57;
